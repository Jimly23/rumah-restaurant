    ...
    <section className="bg-[#dad1c1] py-20 px-5 md:px-10 font-sans overflow-hidden" id="testimonials">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-5xl font-bold text-[#344349] mb-2">Testimonials</h2>
          <p className="text-gray-600 font-playfair text-3xl">What our guests says on review.</p>
        </div>
