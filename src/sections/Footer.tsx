  ...
  return (
    <footer className="py-12 px-4 bg-[#dad1c1] border-t border-white">
      <div className="max-w-7xl mx-auto flex flex-col items-center space-y-8">
        ...
        {/* Brand/Service Links */}
        <nav className="flex flex-wrap font-playfair justify-center gap-x-8 gap-y-4">
          <a 
            href="#home" 
            className="text-xs md:text-lg tracking-[0.2em] text-gray-800 hover:text-amber-600 transition-colors"
          >
            Home
          </a>
          <a 
        ...
        <a href="/legal-notice" className='text-xs md:text-lg tracking-[0.2em] text-gray-800 hover:text-amber-600 transition-colors'>
          Legal & Privacy Notice
        </a>
        ...
        <div className="text-center">
          <p className="text-sm md:text-base text-gray-500 tracking-wide font-light">
            &copy; {new Date().getFullYear()} Rumah Restaurant. All Rights Reserved.
          </p>
        </div>
      </div>
