...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      ...
      link: "https://instagram.com/rumahrestaurant",
    },
    {
      id: 3,
      icon: <Phone size={20} />,
      content: "+9714-3293229 / +9715-65216026",
    ...
    },
    {
      ...
      link: "https://maps.google.com/?q=Rumah+Restaurant+Dubai",
    },
  ];

  return (
    <section className="bg-white py-24 px-6 md:px-12 font-sans overflow-hidden" id="contact">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-20 items-start">
        ...
        <div className="space-y-10">
          <h2 className="text-4xl md:text-5xl font-semibold text-[#647985] tracking-tight">
            Visit Us
          </h2>
          ...
          <div className="flex flex-col gap-8">
            {contactInfo.map((item) => (
              <div key={item.id} className="flex items-center gap-5 group">
                <div className="text-[#647985] w-6 flex justify-center group-hover:scale-110 transition-transform">
                  {item.icon}
                </div>
                <a 
                  href={item.link}
                  ...
                  className="text-[#647985] text-base md:text-lg leading-relaxed hover:underline underline-offset-4 decoration-[#c5a059]"
                >
                  {item.content}
                </a>
              </div>
        ...
        <div>
          ...
          <div className="relative w-full h-[350px] md:h-[350px] rounded-2xl overflow-hidden border-[6px] border-white shadow-2xl group/map">
            <a 
            ...
            >
              <Image 
                ...
                alt="Rumah Restaurant Location Map"
                fill
